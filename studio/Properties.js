...
export default class Properties extends Component {
  render () {
    ...
    const recipeProps = entity.markdown || {}
    const changeProps = (change) => onChange(Object.assign({}, entity, { markdown: Object.assign({}, entity.markdown, change) }))

    return (
      <div className='properties-section'>
        <div className='form-group'><label>tables</label>
            <input type='checkbox' checked={recipeProps.tables !== false} onChange={(v) => changeProps({tables: v.target.checked})} />
